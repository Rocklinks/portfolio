...
export default function Resume () {
    return <section className='flex flex:col md:flex-row bg-secondary px-5' id='resume'>
        ...
        <div className='md:w-1/2 flex justify-end'>
            ...
            <h1 className='text-3xl border-b-4 border-[#e026c8] mb-5 w-[140px] font-bold'>Resume</h1>
            <p className='pb-5'>You can view my Resume<div className='mt-8'><a className='btn' href='https://google.com'>Download</a></div></p>
            </div>
        </div>
    </section>
}